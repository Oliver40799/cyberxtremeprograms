...
// =====================================================
// DETENER ADS ANTES DEL FOOTER
// =====================================================

const ads = document.querySelectorAll('.left-ad-container, .right-ad-container');
...
function controlAds(){
    ...
    ads.forEach(ad => {
        ...
        const stopPoint = footerTop - adHeight - 30;

        if(scrollTop + 120 >= stopPoint){

            ad.style.position = "absolute";
            ad.style.top = stopPoint + "px";
...
window.addEventListener("scroll", controlAds);
window.addEventListener("load", controlAds);

window.addEventListener("load",()=>{

const intro = document.getElementById("cx-intro");

if(sessionStorage.getItem("cx_intro_seen")){
intro.style.display="none";
return;
}

sessionStorage.setItem("cx_intro_seen","true");
